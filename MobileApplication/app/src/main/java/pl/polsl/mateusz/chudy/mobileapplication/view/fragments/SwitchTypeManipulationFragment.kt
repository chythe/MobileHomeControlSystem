...
class SwitchTypeManipulationFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        return inflater!!.inflate(R.layout.fragment_switch_manipulation, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment SwitchTypeManipulationFragment.
         */
        // TODO: Rename and change types and number of parameters
        fun newInstance(param1: String, param2: String): SwitchTypeManipulationFragment {
